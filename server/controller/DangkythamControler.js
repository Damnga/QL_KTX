...
import {getAllDangKyTham, getDangKyThamById, createDangKyTham, updateDangKyTham, deleteDangKyTham} from "../model/DangkythamModel.js"
...
export const getDangKyTham = async (req, res, next) => {
  try {
...
export const getADangKyThamId = async (req, res, next) => {
  try {
