    ...
    <div className='user'>
      <div className="user_container">
        ...
        <div className="room_button">
          <button className={`btn toanha ${currentTab === 'toanha' ? 'active-toanha' : ''}`} onClick={() => setCurrentTab('toanha')}>Danh Sách Sinh Viên</button>
          <button className={`btn phong ${currentTab === 'phong' ? 'active-phong' : ''}`} onClick={() => setCurrentTab('phong')}> Hợp Đồng</button>
          <button className={`btn ds ${currentTab === 'ds' ? 'active-ds' : ''}`}onClick={() => setCurrentTab('ds')}>Hồ Sơ</button>
          <button className={`btn baotri ${currentTab === 'baotri' ? 'active-baotri' : ''}`} onClick={() => setCurrentTab('baotri')}>Người Thân</button>
        </div>
        {currentTab === 'ds' && (
